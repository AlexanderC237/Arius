...
from arius.status_codes import (PurchaseOrderStatus, ReturnOrderLineStatus,
...
class OrderTest(AriusAPITestCase):
...
class PurchaseOrderDownloadTest(OrderTest):
    ...
    def test_download_csv(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Arius_PurchaseOrders.csv',
        ) as file:
    ...
    def test_download_line_items(self):
        ...
        with self.download_file(
            ...
            decode=False,
            expected_code=200,
            expected_fn='Arius_PurchaseOrderItems.xlsx',
        ) as file:
    ...
    def test_export(self):
        ...
        for fmt in ['csv', 'xls', 'xlsx']:
            self.download_file(
                ...
                expected_code=200,
                expected_fn=f"Arius_SalesOrders.{fmt}"
            )
...
class SalesOrderDownloadTest(OrderTest):
    ...
    def test_download_xls(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Arius_SalesOrders.xls',
            decode=False,
        ) as file:
            self.assertTrue(isinstance(file, io.BytesIO))
    ...
    def test_download_csv(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Arius_SalesOrders.csv',
            decode=True
        ) as file:
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Arius_SalesOrders.tsv',
            decode=True,
        ) as file:
...
class ReturnOrderTests(AriusAPITestCase):
...
class OrderMetadataAPITest(AriusAPITestCase):
