...
from arius.api import (APIDownloadMixin, AttachmentMixin,
                       ListCreateDestroyAPIView, MetadataView)
from arius.filters import SEARCH_ORDER_FILTER, SEARCH_ORDER_FILTER_ALIAS
from arius.helpers import DownloadFile, str2bool
from arius.helpers_model import construct_absolute_url, get_base_url
from arius.mixins import (CreateAPI, ListAPI, ListCreateAPI,
...
class PurchaseOrderList(PurchaseOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Arius_PurchaseOrders.{export_format}"
...
class PurchaseOrderLineItemList(PurchaseOrderLineItemMixin, APIDownloadMixin, ListCreateDestroyAPIView):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Arius_PurchaseOrderItems.{export_format}"
...
class PurchaseOrderExtraLineList(GeneralExtraLineList, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Arius_ExtraPurchaseOrderLines.{export_format}"
...
class SalesOrderList(SalesOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Arius_SalesOrders.{export_format}"
...
class SalesOrderLineItemList(SalesOrderLineItemMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Arius_SalesOrderItems.{export_format}"
...
class SalesOrderExtraLineList(GeneralExtraLineList, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Arius_ExtraSalesOrderLines.{export_format}"
...
class ReturnOrderList(ReturnOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Arius_ReturnOrders.{export_format}"
...
class OrderCalendarExport(ICalFeed):
    ...
    def title(self, obj):
        ...
        return f'{common_models.AriusSetting.get_setting("ARIUS_COMPANY_NAME")} {ordertype_title}'
