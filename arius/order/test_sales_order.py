...
import order.tasks
from common.models import AriusSetting, NotificationMessage
...
class SalesOrderTest(TestCase):
    ...
    def test_default_shipment(self):
        ...
        self.assertEqual(False, AriusSetting.get_setting('SALESORDER_DEFAULT_SHIPMENT'))
        ...
        AriusSetting.set_setting('SALESORDER_DEFAULT_SHIPMENT', True, None)
        self.assertEqual(True, AriusSetting.get_setting('SALESORDER_DEFAULT_SHIPMENT'))
