...
from arius.admin import AriusResource
...
class PurchaseOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, AriusResource):
...
class PurchaseOrderLineItemResource(PriceResourceMixin, AriusResource):
...
class PurchaseOrderExtraLineResource(PriceResourceMixin, AriusResource):
...
class SalesOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, AriusResource):
...
class SalesOrderLineItemResource(PriceResourceMixin, AriusResource):
    ...
    def dehydrate_sale_price(self, item):
        ...
        Ref: https://github.com/ariustechnology/Arius/issues/2207
        """
        if item.sale_price:
...
class SalesOrderExtraLineResource(PriceResourceMixin, AriusResource):
...
class ReturnOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, AriusResource):
...
class ReturnOrderLineItemResource(PriceResourceMixin, AriusResource):
...
class ReturnOrderExtraLineClass(PriceResourceMixin, AriusResource):
