...
from arius.helpers import DownloadFile
from arius.views import AjaxView, AriusRoleMixin
...
class PurchaseOrderIndex(AriusRoleMixin, ListView):
...
class SalesOrderIndex(AriusRoleMixin, ListView):
...
class ReturnOrderIndex(AriusRoleMixin, ListView):
...
class PurchaseOrderDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
...
class SalesOrderDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
...
class ReturnOrderDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
