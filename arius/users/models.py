...
class RuleSet(models.Model):
    ...
    There are *many* apps models used within arius,
...
def update_group_roles(group, debug=False):
    ...
    a) Whenever the arius database is launched
...
class Owner(models.Model):
    ...
    Owner can be associated to any arius model (part, stock, build, etc.)
