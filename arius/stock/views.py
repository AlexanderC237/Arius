...
class StockIndex(AriusRoleMixin, AriusPluginViewMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['ownership_enabled'] = common.models.AriusSetting.get_setting('STOCK_OWNERSHIP_CONTROL')

        return context


class StockLocationDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
...
class StockItemDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data['ownership_enabled'] = common.models.AriusSetting.get_setting('STOCK_OWNERSHIP_CONTROL')
