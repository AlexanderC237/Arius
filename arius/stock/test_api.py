...
class StockAPITestCase(AriusAPITestCase):
...
class StockItemListTest(StockAPITestCase):
    ...
    def test_filter_by_expired(self):
        ...
        AriusSetting.set_setting('STOCK_ENABLE_EXPIRY', True, self.user)
...
class StockTestResultTest(StockAPITestCase):
    ...
    def test_post_bitmap(self):
        ...
        For some (unknown) reason, prior to fix https://github.com/ariustechnology/Arius/pull/2018
...
class StockMetadataAPITest(AriusAPITestCase):
