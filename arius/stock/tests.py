...
from arius.status_codes import StockHistoryCode
...
class StockTestBase(AriusTestCase):
...
class StockTest(StockTestBase):
    ...
    def test_serial_numbers(self):
        ...
        AriusSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', True, self.user)
        ...
        AriusSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', False, self.user)
    ...
    def test_serials(self):
        ...
        AriusSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', False, None)
    ...
    def test_location_tree(self):
        ...
        Ref: https://github.com/ariustechnology/Arius/issues/2636
        Ref: https://github.com/ariustechnology/Arius/issues/2733
        """
