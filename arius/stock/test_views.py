...
class StockViewTestCase(AriusTestCase):
...
class StockOwnershipTest(StockViewTestCase):
    ...
    def enable_ownership(self):
        ...
        AriusSetting.set_setting('STOCK_OWNERSHIP_CONTROL', True, self.user)
        self.assertEqual(True, AriusSetting.get_setting('STOCK_OWNERSHIP_CONTROL'))
