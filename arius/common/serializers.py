...
from arius.helpers import get_objectreference
from arius.helpers_model import construct_absolute_url
from arius.serializers import (AriusImageSerializerField,
                               AriusModelSerializer)


class SettingsSerializer(AriusModelSerializer):
...
class GlobalSettingsSerializer(SettingsSerializer):
    """Serializer for the AriusSetting model."""

    class Meta:
        """Meta options for GlobalSettingsSerializer."""

        model = common_models.AriusSetting
        fields = [
            'pk',
            'key',
            'value',
...
class UserSettingsSerializer(SettingsSerializer):
    """Serializer for the AriusUserSetting model."""

    class Meta:
        """Meta options for UserSettingsSerializer."""

        model = common_models.AriusUserSetting
        fields = [
            'pk',
            'key',
            'value',
...
class NotificationMessageSerializer(AriusModelSerializer):
    """Serializer for the AriusUserSetting model."""
...
class NewsFeedEntrySerializer(AriusModelSerializer):
...
class ConfigSerializer(serializers.Serializer):
    """Serializer for the arius configuration.
...
class NotesImageSerializer(AriusModelSerializer):
    ...
    image = AriusImageSerializerField(required=True)


class ProjectCodeSerializer(AriusModelSerializer):
