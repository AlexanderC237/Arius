...
from arius.helpers_model import getModelsWithMixin
from arius.models import AriusNotesMixin
...
def update_news_feed():
    ...
    try:
        d = feedparser.parse(settings.ARIUS_NEWS_URL)
...
def delete_old_notes_images():
    ...
    note_classes = getModelsWithMixin(AriusNotesMixin)
