...
class MethodStorageClass:
    """Class that works as registry for all available notification methods in arius.
    ...
    def collect(self, selected_classes=None):
        ...
        current_method = arius.helpers.inheritors(NotificationMethod) - IGNORED_NOTIFICATION_CLS
...
class AriusNotificationBodies:
    """Default set of notifications for arius.
