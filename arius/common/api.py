...
from arius.api import BulkDeleteMixin, MetadataView
from arius.config import CONFIG_LOOKUPS
from arius.filters import ORDER_FILTER, SEARCH_ORDER_FILTER
from arius.helpers import inheritors
from arius.mixins import (ListAPI, ListCreateAPI, RetrieveAPI,
                          RetrieveUpdateAPI, RetrieveUpdateDestroyAPI)
from arius.permissions import IsStaffOrReadOnly, IsSuperuser
...
class CurrencyExchangeView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            backend = ExchangeBackend.objects.filter(name='AriusExchange')
        ...
        response = {
            'base_currency': common.models.AriusSetting.get_setting('ARIUS_DEFAULT_CURRENCY', 'USD'),
            'exchange_rates': {},
            'updated': updated,
        }
...
class CurrencyRefreshView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        from arius.tasks import update_exchange_rates
...
class GlobalSettingsList(SettingsList):
    ...
    queryset = common.models.AriusSetting.objects.exclude(key__startswith="_")
...
class GlobalSettingsDetail(RetrieveUpdateAPI):
    ...
    def get_object(self):
        ...
        if key not in common.models.AriusSetting.SETTINGS.keys():
            raise NotFound()

        return common.models.AriusSetting.get_setting_object(
            key,
...
class UserSettingsList(SettingsList):
    ...
    queryset = common.models.AriusUserSetting.objects.all()
    ...
    def filter_queryset(self, queryset):
        ...
        try:
            ...
            return common.models.AriusUserSetting.objects.none()
...
class UserSettingsDetail(RetrieveUpdateAPI):
    ...
    def get_object(self):
        ...
        if key not in common.models.AriusUserSetting.SETTINGS.keys():
            raise NotFound()

        return common.models.AriusUserSetting.get_setting_object(
            key,
            user=self.request.user,
            cache=False, create=True
        )
