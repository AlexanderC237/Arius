...
class PluginConfig(arius.models.MetadataMixin, models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Save plugin
        self.plugin: AriusPlugin = plugin
...
class PluginSetting(common.models.BaseAriusSetting):
    ...
    def get_setting_definition(cls, key, **kwargs):
        """In the BaseAriusSetting class, we have a class attribute named 'SETTINGS', which is a dict object that fully defines all the setting parameters.

        Here, unlike the BaseAriusSetting, we do not know the definitions of all settings
...
class NotificationUserSetting(common.models.BaseAriusSetting):
