...
from arius.mixins import (CreateAPI, ListAPI, RetrieveUpdateAPI,
                          RetrieveUpdateDestroyAPI, UpdateAPI)
from arius.permissions import IsSuperuser
...
def check_plugin(plugin_slug: str, plugin_pk: int) -> AriusPlugin:
    ...
    Returns:
        AriusPlugin: The config object for the provided plugin.
    """
