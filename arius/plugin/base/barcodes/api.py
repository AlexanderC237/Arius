...
from arius.helpers import hash_barcode
from plugin import registry
from plugin.builtin.barcodes.arius_barcode import \
    AriusInternalBarcodePlugin
...
class BarcodeScan(APIView):
    ...
    A barcode could follow the internal arius barcode format,
...
class BarcodeAssign(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Here we only check against 'arius' plugins
        ...
        for model in AriusInternalBarcodePlugin.get_supported_barcode_models():
...
class BarcodeUnassign(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        supported_models = AriusInternalBarcodePlugin.get_supported_barcode_models()
