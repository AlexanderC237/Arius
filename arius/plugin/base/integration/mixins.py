...
import part.models
import stock.models
from arius.helpers import generateTestKey
...
class ValidationMixin:
    """Mixin class that allows custom validation for various parts of arius
...
class APICallMixin:
    ...
    class SampleApiCallerPlugin(APICallMixin, SettingsMixin, AriusPlugin):
        '''
