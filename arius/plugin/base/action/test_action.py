...
class ActionMixinTests(TestCase):
    ...
    def setUp(self):
        ...
        """
        class SimplePlugin(ActionMixin, AriusPlugin):
            pass
        self.plugin = SimplePlugin()

        class TestActionPlugin(ActionMixin, AriusPlugin):
            """An action plugin."""
            ACTION_NAME = 'abc123'
        ...
        class NameActionPlugin(ActionMixin, AriusPlugin):
            NAME = 'Aplugin'
