...
class PlgMixin:
    ...
    def get_plugin(self):
        ...
        return AriusCoreNotificationsPlugin


class AriusCoreNotificationsPlugin(SettingsContentMixin, SettingsMixin, AriusPlugin):
    """Core notification methods for arius."""

    NAME = "AriusCoreNotificationsPlugin"
    TITLE = _("arius Notifications")
    AUTHOR = _('arius contributors')
    ...
    class EmailNotification(PlgMixin, BulkNotificationMethod):
        ...
        def get_targets(self):
            ...
            for user in self.targets:
                ...
                allows_emails = arius.helpers.str2bool(self.usersetting(user))
        ...
        def send_bulk(self):
            ...
            instance_title = common.models.AriusSetting.get_setting('ARIUS_INSTANCE')
            ...
            arius.email.send_email(subject, '', targets, html_message=html_message)
