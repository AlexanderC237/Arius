"""Unit tests for AriusBarcodePlugin."""
...
class TestAriusBarcode(AriusAPITestCase):
    """Tests for the integrated AriusBarcode barcode plugin."""
    ...
    def test_assign_to_part(self):
        ...
        self.assertEqual(response.data['plugin'], 'AriusBarcode')
        self.assertEqual(response.data['part']['pk'], 1)
