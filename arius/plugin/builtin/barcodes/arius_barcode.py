"""The AriusBarcodePlugin validates barcodes generated by arius itself. It can be used as a template for developing third-party barcode plugins.

The data format is very simple, and maps directly to database objects,
via the "id" parameter.

Parsing an arius barcode simply involves validating that the
...
class AriusInternalBarcodePlugin(BarcodeMixin, AriusPlugin):
    """Builtin BarcodePlugin for matching and generating internal barcodes."""

    NAME = "AriusBarcode"
    TITLE = _("arius Barcodes")
    ...
    def get_supported_barcode_models():
        ...
        return getModelsWithMixin(AriusBarcodeMixin)
    ...
    def scan(self, barcode_data):
        ...
        Here we are looking for a dict object which contains a reference to a particular arius database object
        """
        ...
        # This is the internal barcode representation that arius uses
        barcode_dict = None
