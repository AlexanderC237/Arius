...
from arius import status_codes as status
...
class BuildTest(BuildTestBase):
    ...
    def test_ref_int(self):
        ...
        common.models.AriusSetting.set_setting('BUILDORDER_REFERENCE_PATTERN', 'BO-{ref}-???', change_user=None)
    ...
    def test_ref_validation(self):
        ...
        common.models.AriusSetting.set_setting('BUILDORDER_REFERENCE_PATTERN', '{ref}-BO', change_user=None)
    ...
    def test_next_ref(self):
        ...
        common.models.AriusSetting.set_setting('BUILDORDER_REFERENCE_PATTERN', 'XYZ-{ref:06d}', change_user=None)
