...
from arius.serializers import AriusModelSerializer, AriusAttachmentSerializer
from arius.serializers import UserSerializer

import arius.helpers
from arius.serializers import AriusDecimalField
from arius.status_codes import StockStatus
...
class BuildSerializer(AriusModelSerializer):
    ...
    def validate_output(self, output):
        ...
        if to_complete:
            ...
            if not build.is_output_fully_allocated(output):
                ...
                accept_incomplete = arius.helpers.str2bool(self.context['request'].data.get('accept_incomplete_allocation', False))
...
class BuildOutputCreateSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if serial_numbers:
            ...
            try:
                self.serials = arius.helpers.extract_serial_numbers(
                    serial_numbers,
                    quantity,
...
class BuildAllocationItemSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if quantity > q:
            ...
            q = arius.helpers.clean_decimal(q)
...
class BuildItemSerializer(AriusModelSerializer):
...
class BuildLineSerializer(AriusModelSerializer):
...
class BuildAttachmentSerializer(AriusAttachmentSerializer):
