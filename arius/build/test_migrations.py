...
class TestReferencePatternMigration(MigratorTestCase):
    ...
    Ref: https://github.com/ariustechnology/Arius/pull/3267
    """
    ...
    def prepare(self):
        ...
        Setting = self.old_state.apps.get_model('common', 'ariussetting')
    ...
    def test_reference_migration(self):
        ...
        Setting = self.new_state.apps.get_model('common', 'ariussetting')
...
class TestBuildLineCreation(MigratorTestCase):
    ...
    Ref: https://github.com/ariustechnology/Arius/pull/4855
