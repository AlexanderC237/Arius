...
from arius.api import AttachmentMixin, APIDownloadMixin, ListCreateDestroyAPIView, MetadataView
from generic.states import StatusView
from arius.helpers import str2bool, isNull, DownloadFile
from arius.status_codes import BuildStatus, BuildStatusGroups
from arius.mixins import CreateAPI, RetrieveUpdateDestroyAPI, ListCreateAPI
...
from arius.filters import SEARCH_ORDER_FILTER_ALIAS
...
class BuildList(APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Arius_BuildOrders.{export_format}"
