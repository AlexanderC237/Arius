...
class CompanyTest(AriusAPITestCase):
...
class ContactTest(AriusAPITestCase):
...
class AddressTest(AriusAPITestCase):
...
class ManufacturerTest(AriusAPITestCase):
...
class SupplierPartTest(AriusAPITestCase):
...
class CompanyMetadataAPITest(AriusAPITestCase):
