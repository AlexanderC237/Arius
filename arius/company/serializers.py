...
from arius.serializers import (AriusAttachmentSerializer,
                               ...
                               AriusDecimalField,
                               AriusImageSerializerField,
                               AriusModelSerializer,
                               AriusMoneySerializer,
                               AriusTagModelSerializer,
                               RemoteImageMixin)
...
class CompanyBriefSerializer(AriusModelSerializer):
...
class AddressSerializer(AriusModelSerializer):
...
class AddressBriefSerializer(AriusModelSerializer):
...
class CompanySerializer(RemoteImageMixin, AriusModelSerializer):
    ...
    image = AriusImageSerializerField(required=False, allow_null=True)

    parts_supplied = serializers.IntegerField(read_only=True)
    parts_manufactured = serializers.IntegerField(read_only=True)
    address_count = serializers.IntegerField(read_only=True)

    currency = AriusCurrencySerializer(help_text=_('Default currency used for this supplier'), required=True)
...
class CompanyAttachmentSerializer(AriusAttachmentSerializer):
...
class ContactSerializer(AriusModelSerializer):
...
class ManufacturerPartSerializer(AriusTagModelSerializer):
...
class ManufacturerPartAttachmentSerializer(AriusAttachmentSerializer):
...
class ManufacturerPartParameterSerializer(AriusModelSerializer):
...
class SupplierPartSerializer(AriusTagModelSerializer):
...
class SupplierPriceBreakSerializer(AriusModelSerializer):
