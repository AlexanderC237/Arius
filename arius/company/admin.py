...
class CompanyResource(AriusResource):
...
class SupplierPartResource(AriusResource):
...
class ManufacturerPartResource(AriusResource):
...
class ManufacturerPartParameterResource(AriusResource):
...
class SupplierPriceBreakResource(AriusResource):
...
class AddressResource(AriusResource):
...
class ContactResource(AriusResource):
