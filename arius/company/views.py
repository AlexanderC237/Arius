...
class CompanyIndex(AriusRoleMixin, ListView):
...
class CompanyDetail(AriusPluginViewMixin, DetailView):
...
class ManufacturerPartDetail(AriusPluginViewMixin, DetailView):
...
class SupplierPartDetail(AriusPluginViewMixin, DetailView):
