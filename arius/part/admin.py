...
class PartResource(AriusResource):
...
class PartImportResource(AriusResource):
    """Class for managing Part data import/export."""
...
class PartCategoryResource(AriusResource):
...
class BomItemResource(AriusResource):
...
class ParameterResource(AriusResource):
