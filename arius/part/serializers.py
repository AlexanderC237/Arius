...
import arius.helpers
import arius.serializers
import arius.status
import part.filters
import part.tasks
import stock.models
from arius.status_codes import BuildStatusGroups
from arius.tasks import offload_task
...
class CategorySerializer(arius.serializers.AriusModelSerializer):
...
class CategoryTree(arius.serializers.AriusModelSerializer):
...
class PartAttachmentSerializer(arius.serializers.AriusAttachmentSerializer):
    ...
    class Meta:
        ...
        fields = arius.serializers.AriusAttachmentSerializer.attachment_fields([
            'part',
        ])


class PartTestTemplateSerializer(arius.serializers.AriusModelSerializer):
...
class PartSalePriceSerializer(arius.serializers.AriusModelSerializer):
    ...
    quantity = arius.serializers.AriusDecimalField()

    price = arius.serializers.AriusMoneySerializer(allow_null=True)

    price_currency = arius.serializers.AriusCurrencySerializer(help_text=_('Purchase currency of this stock item'))


class PartInternalPriceSerializer(arius.serializers.AriusModelSerializer):
    ...
    price = arius.serializers.AriusMoneySerializer(
        allow_null=True
    )
...
class PartThumbSerializerUpdate(arius.serializers.AriusModelSerializer):
    ...
    image = arius.serializers.AriusAttachmentSerializerField(required=True)


class PartParameterTemplateSerializer(arius.serializers.AriusModelSerializer):
...
class PartParameterSerializer(arius.serializers.AriusModelSerializer):
...
class PartBriefSerializer(arius.serializers.AriusModelSerializer):
    ...
    # Pricing fields
    pricing_min = arius.serializers.AriusMoneySerializer(source='pricing_data.overall_min', allow_null=True, read_only=True)
    pricing_max = arius.serializers.AriusMoneySerializer(source='pricing_data.overall_max', allow_null=True, read_only=True)
...
class PartSerializer(arius.serializers.RemoteImageMixin, arius.serializers.AriusTagModelSerializer):
    ...
    image = arius.serializers.AriusImageSerializerField(required=False, allow_null=True)
    thumbnail = serializers.CharField(source='get_thumbnail_url', read_only=True)
    starred = serializers.SerializerMethodField()
...
class PartStocktakeSerializer(arius.serializers.AriusModelSerializer):
    ...
    user_detail = arius.serializers.UserSerializer(source='user', read_only=True, many=False)

    cost_min = arius.serializers.AriusMoneySerializer(allow_null=True)
    cost_min_currency = arius.serializers.AriusCurrencySerializer()

    cost_max = arius.serializers.AriusMoneySerializer(allow_null=True)
    cost_max_currency = arius.serializers.AriusCurrencySerializer()
...
class PartStocktakeReportSerializer(arius.serializers.AriusModelSerializer):
    ...
    report = arius.serializers.AriusAttachmentSerializerField(read_only=True)
...
class PartPricingSerializer(arius.serializers.AriusModelSerializer):
    ...
    # Custom serializers
    bom_cost_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    bom_cost_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    purchase_cost_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    purchase_cost_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    internal_cost_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    internal_cost_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    supplier_price_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    supplier_price_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    variant_cost_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    variant_cost_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    overall_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    overall_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    sale_price_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    sale_price_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)

    sale_history_min = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    sale_history_max = arius.serializers.AriusMoneySerializer(allow_null=True, read_only=True)
    ...
    def save(self):
        ...
        if arius.helpers.str2bool(data.get('update', False)):
            # Update part pricing
            pricing = self.instance
            pricing.update_pricing()


class PartRelationSerializer(arius.serializers.AriusModelSerializer):
...
class PartStarSerializer(arius.serializers.AriusModelSerializer):
...
class BomItemSubstituteSerializer(arius.serializers.AriusModelSerializer):
...
class BomItemSerializer(arius.serializers.AriusModelSerializer):
    ...
    quantity = arius.serializers.AriusDecimalField(required=True)
    ...
    pricing_min = arius.serializers.AriusMoneySerializer(source='sub_part.pricing.overall_min', allow_null=True, read_only=True)
    pricing_max = arius.serializers.AriusMoneySerializer(source='sub_part.pricing.overall_max', allow_null=True, read_only=True)
...
class CategoryParameterTemplateSerializer(arius.serializers.AriusModelSerializer):
...
class BomImportUploadSerializer(arius.serializers.DataFileUploadSerializer):
...
class BomImportExtractSerializer(arius.serializers.DataFileExtractSerializer):
