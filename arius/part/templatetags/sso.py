...
def sso_login_enabled():
    ...
    return str2bool(AriusSetting.get_setting('LOGIN_ENABLE_SSO'))


@register.simple_tag()
def sso_reg_enabled():
    """Return True if single-sign-on is enabled for self-registration"""
    return str2bool(AriusSetting.get_setting('LOGIN_ENABLE_SSO_REG'))


@register.simple_tag()
def sso_auto_enabled():
    """Return True if single-sign-on is enabled for auto-registration"""
    return str2bool(AriusSetting.get_setting('LOGIN_SIGNUP_SSO_AUTO'))
