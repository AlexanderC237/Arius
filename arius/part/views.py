...
from arius.helpers import str2bool, str2int
from arius.views import AjaxUpdateView, AjaxView, AriusRoleMixin
...
class PartIndex(AriusRoleMixin, AriusPluginViewMixin, ListView):
...
class PartDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
...
class BomUpload(AriusRoleMixin, DetailView):
...
class PartPricing(AjaxView):
    ...
    def get_pricing(self, quantity=1, currency=None):
        ...
        if part.bom_count > 0:
            ...
            use_internal = AriusSetting.get_setting('PART_BOM_USE_INTERNAL_PRICE', False)
...
class CategoryDetail(AriusRoleMixin, AriusPluginViewMixin, DetailView):
