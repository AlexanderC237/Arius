...
from arius.helpers_model import get_base_url
from arius.models import MetadataMixin
...
class ReportTemplateBase(MetadataMixin, ReportBase):
    ...
    def context(self, request):
        ...
        context['default_page_size'] = common.models.AriusSetting.get_setting('REPORT_DEFAULT_PAGE_SIZE')
