...
function downloadBomTemplate(options={}) {
    ...
    if (!format) {
        format = ariusLoad('bom-export-format', 'csv');
    }
    ...
    constructFormBody({}, {
        ...
        onSubmit: function(fields, opts) {
            ...
            ariusSave('bom-export-format', format);
    ...
    constructFormBody({}, {
        ...
        fields: {
            format: {
                ...
                required: true,
                type: 'choice',
                value: ariusLoad('bom-export-format', 'csv'),
                choices: exportFormatOptions(),
            },
            cascade: {
                ...
                type: 'boolean',
                value: ariusLoad('bom-export-cascading', true),
            },
            levels: {
                label: '{% trans "Levels" %}',
