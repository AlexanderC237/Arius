...
function serializeStockItem(pk, options={}) {
    ...
    if (options.part) {
        ...
        ariusGet(`{% url "api-part-list" %}${options.part}/serial-numbers/`, {}, {
            ...
            onSelect: function(data, field, opts) {
                ...
                if (options.create) {
                    ...
                    if (data.trackable) {
                        ...
                        ariusGet(`{% url "api-part-list" %}${data.pk}/serial-numbers/`, {}, {
                            success: function(data) {
                                var placeholder = '';
                                if (data.next) {
...
function duplicateStockItem(pk, options) {
    ...
    ariusGet(`{% url "api-stock-list" %}${pk}/`, {}, {
        success: function(data) {
...
function loadStockLocationTable(table, options) {
    ...
    var tree_view = options.allowTreeView && ariusLoad('location-tree-view') == 1;
    ...
    table.ariusTable({
        ...
        onPostBody: function() {
            ...
            if (options.allowTreeView) {
                ...
                tree_view = ariusLoad('location-tree-view') == 1;
        ...
        buttons: options.allowTreeView ? [
            {
                ...
                event: () => {
                    ariusSave('location-tree-view', 0);
            ...
            },
            {
                ...
                event: () => {
                    ariusSave('location-tree-view', 1);
