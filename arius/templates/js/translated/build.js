...
function duplicateBuildOrder(build_id, options={}) {
    ...
    ariusGet(`{% url "api-build-list" %}${build_id}/`, {}, {
    ...
    ariusGet(
        ...
        {},
        {
            success: function(build) {
                ...
                ariusGet(`{% url "api-part-list" %}${build.part}/serial-numbers/`, {}, {
                    success: function(data) {
                        if (data.next) {
...
function allocateStockToBuild(build_id, line_items, options={}) {
    ...
    if (output_id) {
        ...
        ariusGet(`{% url "api-stock-list" %}${output_id}/`, {}, {
            async: false,
...
function loadBuildTable(table, options) {
    ...
    var display_mode = ariusLoad('build-table-display-mode', 'list');
...
function loadBuildLineTable(table, build_id, options={}) {
    ...
    $(table).ariusTable(table_options);
