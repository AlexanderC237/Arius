...
function baseCurrency() {
    return global_settings.ARIUS_DEFAULT_CURRENCY || 'USD';
}
...
function formatCurrency(value, options={}) {
    ...
    let currency = options.currency || global_settings.ARIUS_DEFAULT_CURRENCY || 'USD';
...
function getCurrencyConversionRates(cache=true) {
    ...
    ariusGet('{% url "api-currency-exchange" %}', {}, {
        async: false,
