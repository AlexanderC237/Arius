...
function activatePanel(label, panel_name, options={}) {
    ...
    localStorage.setItem(`arius-selected-panel-${label}`, panel_name);
...
function enableSidebar(label, options={}) {
    ...
    var selected_panel = $.urlParam('display') || localStorage.getItem(`arius-selected-panel-${label}`) || options.default;
    ...
    if (options.hide_toggle) {
        ...
        $('#sidebar-toggle').click(function() {
            ...
            var state = localStorage.getItem(`arius-menu-state-${label}`) || 'expanded';
    ...
    ariusGet(
        ...
        filters,
        {
            success: function(data) {
                ...
                // Data are returned from the arius server as a flattened list;
...
function setSidebarState(label, state) {
    ...
    localStorage.setItem(`arius-menu-state-${label}`, state);
}
