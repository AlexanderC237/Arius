...
class ExchangeRateMixin:
    ...
    def generate_exchange_rates(self):
        ...
        backend = ExchangeBackend.objects.get(name='AriusExchange')
...
class AriusTestCase(ExchangeRateMixin, UserMixin, TestCase):
    """Testcase with user setup buildin."""
    pass


class AriusAPITestCase(ExchangeRateMixin, UserMixin, APITestCase):
    """Base class for running arius API tests."""
