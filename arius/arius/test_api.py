"""Low level tests for the arius API."""
...
class HTMLAPITests(AriusTestCase):
    """Test that we can access the REST API endpoints via the HTML interface.

    History: Discovered on 2021-06-28 a bug in AriusModelSerializer,
...
class APITests(AriusAPITestCase):
    """Tests for the arius API."""
    ...
    def test_info_view(self):
        ...
        self.assertEqual('arius', data['server'])
...
class BulkDeleteTests(AriusAPITestCase):
...
class SearchTests(AriusAPITestCase):
