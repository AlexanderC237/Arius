...
class AriusRoleMixin(PermissionRequiredMixin):
...
class AjaxMixin(AriusRoleMixin):
...
class SetPasswordView(AjaxUpdateView):
    ...
    ajax_template_name = "arius/password.html"
...
class IndexView(TemplateView):
    """View for arius index page."""

    template_name = 'arius/index.html'


class SearchView(TemplateView):
    """View for arius search page.

    Displays results of search query
    """

    template_name = 'arius/search.html'
...
class SettingsView(TemplateView):
    ...
    template_name = "arius/settings/settings.html"

    def get_context_data(self, **kwargs):
        """Add data for template."""
        ctx = super().get_context_data(**kwargs).copy()

        ctx['settings'] = common_models.AriusSetting.objects.all().order_by('key')

        ctx["base_currency"] = common_settings.currency_code_default()
        ctx["currencies"] = common_settings.currency_codes

        ctx["rates"] = Rate.objects.filter(backend="AriusExchange")
        ...
        # load locale stats
        STAT_FILE = settings.BASE_DIR.joinpath('arius/locale_stats.json').absolute()
...
class AboutView(AjaxView):
    """A view for displaying arius version information"""

    ajax_template_name = "about.html"
    ajax_form_title = _("About arius")


class NotificationsView(TemplateView):
    """View for showing notifications."""

    template_name = "arius/notifications/notifications.html"
