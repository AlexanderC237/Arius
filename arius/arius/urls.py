"""Top-level URL lookup for arius application.
...
admin.site.site_header = "arius Admin"
...
apipatterns = [
    ...
    # arius information endpoint
    path('', InfoView.as_view(), name='api-arius-info'),
...
settings_urls = [
    ...
    re_path(r'^.*$', SettingsView.as_view(template_name='arius/settings/settings.html'), name='settings'),
]
...
backendpatterns = [
    # "Dynamic" javascript files which are rendered using arius templating.
...
frontendpatterns = [
    ...
    # admin sites
    re_path(f'^{settings.ARIUS_ADMIN_URL}/error_log/', include('error_report.urls')),
    re_path(f'^{settings.ARIUS_ADMIN_URL}/', admin.site.urls, name='arius-admin'),
    ...
    # See https://github.com/ariustechnology/Arius/security/advisories/GHSA-8j76-mm54-52xq
