...
class AriusSearchFilter(filters.SearchFilter):
    ...
    def get_search_fields(self, view, request):
        ...
        regex = arius.helpers.str2bool(request.query_params.get('search_regex', False))
    ...
    def get_search_terms(self, request):
        ...
        whole = arius.helpers.str2bool(request.query_params.get('search_whole', False))
...
class AriusOrderingFilter(filters.OrderingFilter):
