...
class SocialProvierListView(ListAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        data = {
            'sso_enabled': AriusSetting.get_setting('LOGIN_ENABLE_SSO'),
            'sso_registration': AriusSetting.get_setting('LOGIN_ENABLE_SSO_REG'),
            'mfa_required': AriusSetting.get_setting('LOGIN_ENFORCE_MFA'),
