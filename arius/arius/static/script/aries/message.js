...
function addCachedAlert(message, options = {}) {
  var alerts = sessionStorage.getItem("arius-alerts");
  ...
  sessionStorage.setItem("arius-alerts", JSON.stringify(alerts));
}
...
function clearCachedAlerts() {
  sessionStorage.removeItem("arius-alerts");
}
...
function showCachedAlerts() {
  var alerts = JSON.parse(sessionStorage.getItem("arius-alerts")) || [];
