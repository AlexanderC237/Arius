...
from arius.ready import canAppAccessDatabase, isInTestMode

logger = logging.getLogger("arius")


class AriusConfig(AppConfig):
    """AppConfig for arius app."""
    name = 'arius'
    ...
    def ready(self):
        ...
        if canAppAccessDatabase() or settings.TESTING_ENV:
            arius.tasks.check_for_migrations(worker=False)
        ...
        arius.conversion.get_unit_registry()
    ...
    def remove_obsolete_tasks(self):
        ...
        obsolete = [
            'arius.tasks.delete_expired_sessions',
    ...
    def add_user_on_startup(self):
        ...
        # get values
        add_user = get_setting('ARIUS_ADMIN_USER', 'admin_user')
        add_email = get_setting('ARIUS_ADMIN_EMAIL', 'admin_email')
        add_password = get_setting('ARIUS_ADMIN_PASSWORD', 'admin_password')
