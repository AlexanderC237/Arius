...
echo "### Installer for Arius - source: $publisher/$source_url"
...
if [[ $SUPPORTED != "true" ]]; then
    ...
    echo "Please install manually using https://docs.arius.org/en/stable/start/install/"
    echo "or check https://github.com/ariustechnology/Arius/issues/3836 for packaging for your OS."
    echo "If you think this is a bug please file an issue at"
    echo "https://github.com/ariustechnology/Arius/issues/new?template=install.yaml"
...
wget -qO- https://dl.packager.io/srv/$publisher/arius/key | sudo apt-key add -
echo "### Adding package source"
do_call "sudo wget -O /etc/apt/sources.list.d/arius.list https://dl.packager.io/srv/$publisher/Arius/$source_url/installer/$DIST_OS/$DIST_VER.repo"
...
echo "### Installing Arius"
do_call "sudo apt-get install arius -y"
